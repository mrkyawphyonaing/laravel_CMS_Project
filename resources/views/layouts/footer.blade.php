...
<div class="container-fluid bg-dark text-secondary p-5">
    <div class="row g-5">
        ...
        <div class="col-lg-3 col-md-6">
            ...
            <p class="mb-2"><i class="bi bi-envelope-open text-primary me-2"></i>kyawphyonaing.jobmail@gmail.com</p>
            <p class="mb-0"><i class="bi bi-telephone text-primary me-2"></i>+95 09782877398</p>
        </div>
        <div class="col-lg-3 col-md-6">
