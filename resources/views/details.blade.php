    ...
    <div class="container-fluid py-6 px-5">
        <div class="row g-5">
            <div class="col-lg-8">
                <!-- Blog Detail Start -->
                <div class="mb-5">
                    <img class="img-fluid w-100 mb-5" src="{{url('welcome/img/blog-1.jpg')}}" alt="">
                ...
                <div class="mb-5">
                    ...
                    <div class="d-flex mb-4">
                        <img src="{{url('welcome/img/user.jpg')}}" class="img-fluid rounded-circle" style="width: 45px; height: 45px;">
                        <div class="ps-3">
